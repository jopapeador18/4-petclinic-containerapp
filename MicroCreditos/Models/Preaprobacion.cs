...
namespace MicroCreditos.Models
{
    ...
    //SERIALIZADORES Y CONVERTIDORES
    public static class Serialize
    {
        public static string ToJson(this PreaprobacionRequest self) => JsonConvert.SerializeObject(self, Models.Converter.Settings);
        public static string ToJson(this PreaprobacionResponse self) => JsonConvert.SerializeObject(self, Models.Converter.Settings);
    }
    ...
    public partial class PreaprobacionResponse
    {
        ...
        public static PreaprobacionResponse FromJson(string json) => JsonConvert.DeserializeObject<PreaprobacionResponse>(json, MicroCreditos.Models.Converter.Settings);

        public PreaprobacionResponse(double pPrediction)
        {
